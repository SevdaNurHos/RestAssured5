...
public class ZippoTest {
    ...
    public void checkCountryInResponseBody() {
        ...
        given()
                ...
                .log().body()    // dönen body json data sı,  log.all()
                .statusCode(200) // dönüş kodu 200 mü
                .body("country", equalTo("United States")) // body nin country değişkeni buna eşit Mİ
...
//    https://jsonpathfinder.com/
    ...
    public void extractingJsonPath5() {
        // https://gorest.co.in/public/v1/users  dönen değerdeki bütün name'leri yazdırınız.
    ...
    public void extractingJsonPathResponsAll() {
       ...
       Assert.assertTrue(names.contains("Deepali Asan"));
    ...
    public void extractPOJO_Soru() {
        // aşağıdaki endpointte(link) Dörtağaç Köyüne ait diğer bilgileri yazdırınız
